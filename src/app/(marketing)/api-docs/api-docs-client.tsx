...
const apiEndpoints: ApiEndpoint[] = [
  // Surveys
  {
    ...
    parameters: [
      ...
      { name: "user_id", in: "query", type: "uuid", description: "Filter by professional ID" },
  ...
  // Professionals (Team Members)
  {
    ...
    description: "Get a paginated list of professionals (team members) for your organization.",
    tag: "Professionals",
    parameters: [
      { name: "page", in: "query", type: "integer", description: "Page number" },
      { name: "is_active", in: "query", type: "boolean", description: "Filter by active status" },
  ...
  },
  {
    ...
    tag: "Professionals",
    parameters: [
      { name: "id", in: "path", required: true, type: "uuid", description: "Professional ID" },
    ],
  },
  {
    method: "PATCH",
