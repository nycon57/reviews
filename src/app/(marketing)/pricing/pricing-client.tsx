  ...
  monthly: [
    {
      ...
      cta: { label: "Start Free Trial", href: "/auth/sign-up?plan=starter" },
      highlighted: false,
    },
    {
      tier: "Professional",
      ...
      cta: { label: "Start Free Trial", href: "/auth/sign-up?plan=professional" },
      highlighted: true,
      badge: "Most Popular",
    },
    {
  ...
  yearly: [
    {
      ...
      cta: { label: "Start Free Trial", href: "/auth/sign-up?plan=starter&billing=yearly" },
      highlighted: false,
    },
    {
      tier: "Professional",
      ...
      cta: { label: "Start Free Trial", href: "/auth/sign-up?plan=professional&billing=yearly" },
      highlighted: true,
      badge: "Most Popular",
    },
    {
