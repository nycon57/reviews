...
interface EmailPreferencesContentProps {
  token: string;
  /** Resolved server-side so the first paint is the real UI, not a spinner. */
  initialPreferences: CommunicationPreferencesWithToken | null;
...
export function EmailPreferencesContent({
  ...
  const [preferences, setPreferences] =
    React.useState<CommunicationPreferencesWithToken | null>(initialPreferences);
