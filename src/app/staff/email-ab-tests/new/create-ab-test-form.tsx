  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight font-display leading-tight text-heading">Create A/B Test</h1>
              ...
              return (
                ...
                >
                  <div
                    className={cn(
                      "p-2 rounded-lg mb-2",
                      testType === type.value ? "bg-primary/10 text-primary" : "bg-muted"
                    )}
                  >
