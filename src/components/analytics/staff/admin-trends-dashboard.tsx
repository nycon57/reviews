              ...
              <div className="h-[250px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={ratingTrend} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                    ...
                    <Tooltip contentStyle={CHART_TOOLTIP_STYLE} formatter={(value: number) => [`${value.toFixed(1)} stars`, "Team Avg"]} />
              ...
              <div className="h-[250px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={npsTrend} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                    ...
                    <Tooltip contentStyle={CHART_TOOLTIP_STYLE} formatter={(value: number) => [`${value > 0 ? "+" : ""}${value}`, "Team NPS"]} />
