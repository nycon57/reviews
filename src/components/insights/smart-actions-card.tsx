...
const priorityConfig = {
  high: { badge: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400", label: "Urgent" },
  medium: { badge: "bg-amber-100 text-amber-800 dark:bg-amber-900/30 dark:text-amber-400", label: "Important" },
  low: { badge: "bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400", label: "FYI" },
};
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-3">
        {data.map((action) => {
          const defaultConfig = { badge: "bg-gray-100 text-gray-800 dark:bg-gray-900/30 dark:text-gray-400", label: "Info" };
          ...
          const content = (
            <div
              className={cn(
                ...
                action.priority === "high" && "border-red-200 bg-red-50/50 dark:border-red-900/50 dark:bg-red-950/20",
                action.priority === "medium" && "border-amber-200 bg-amber-50/50 dark:border-amber-900/50 dark:bg-amber-950/20",
                action.priority === "low" && "border-green-200 bg-green-50/50 dark:border-green-900/50 dark:bg-green-950/20",
            ...
            >
              <div
                className={cn(
                  ...
                  action.priority === "high" && "bg-red-100 text-red-600 dark:bg-red-900/50 dark:text-red-400",
                  action.priority === "medium" && "bg-amber-100 text-amber-600 dark:bg-amber-900/50 dark:text-amber-400",
                  action.priority === "low" && "bg-green-100 text-green-600 dark:bg-green-900/50 dark:text-green-400"
                )}
              >
