...
const GoogleLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={cn("w-10 h-10", className)}>
...
const SlackLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 127 127" className={cn("w-10 h-10", className)}>
...
const LinkedInLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" className={cn("w-10 h-10", className)}>
    ...
    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.064 2.064 0 110-4.128 2.064 2.064 0 010 4.128zm1.782 13.019H3.555V9h3.564v11.452z" fill="white"/>
  </svg>
);

// Official Salesforce cloud logo
const SalesforceLogo = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 1000 700" className={cn("w-10 h-10", className)}>
...
const integrations: Integration[] = [
  ...
  { id: "zillow", name: "Zillow", category: "Reviews", logo: <SiZillow className="w-10 h-10" color="#006AFF" /> },
  ...
  { id: "yelp", name: "Yelp", category: "Reviews", logo: <SiYelp className="w-10 h-10" color="#D32323" /> },
  ...
  { id: "mailchimp", name: "Mailchimp", category: "Marketing", logo: <SiMailchimp className="w-10 h-10" color="#FFE01B" /> },
];
