...
export function PublicProfileError({
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-gradient-to-b from-background to-muted/30 px-4 py-16">
      <div className="w-full max-w-md rounded-xl border border-border bg-white p-8 text-center shadow-elevation-1">
        <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-repwell-sage-100/50">
          <WarningCircle
            weight="duotone"
            className="h-8 w-8 text-repwell-teal-300"
          />
        </div>
        <h1 className="mt-6 text-2xl font-display font-bold text-repwell-teal-500">
          {title}
        </h1>
