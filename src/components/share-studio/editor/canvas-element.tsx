...
import type { CanvasElement } from "@/lib/share-studio/template-types";
...
function ElementContent({ element }: { element: CanvasElement }) {
    ...
    return (
      <div
        ...
        style={{
          ...
          textAlign:
            (element.textAlign as React.CSSProperties["textAlign"]) ?? "left",
  ...
  if (element.type === "stats") {
    return (
      ...
      >
        <span style={{ fontWeight: "700", fontSize: "1.4em" }}>
          {element.statValue ?? "0"}
        </span>
  ...
  return (
    <div
      ...
      style={{
        ...
        outline: isSelected ? "2px solid #52796f" : undefined,
        outlineOffset: 1,
      }}
