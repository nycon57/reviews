...
import type { CanvasElement, TextAlignment, ShapeType } from "@/lib/share-studio/template-types";
...
export function PropertyPanel({ editor }: PropertyPanelProps) {
  const { selectedElement, selectedId, updateElement, bringForward, sendBackward, duplicateElement, deleteElement } =
    editor;
          ...
          <div className="grid grid-cols-2 gap-2">
            <div>
              ...
              <Input
                ...
                value={el.rotation}
                onChange={(e) =>
                  update({ rotation: parseFloat(e.target.value) || 0 })
                }
                className="h-7 text-xs"
              />
            </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      update({ lineHeight: parseFloat(e.target.value) || 1.4 })
                    }
                    className="h-7 text-xs"
                  />
                </div>
                    ...
                    {(["left", "center", "right"] as TextAlignment[]).map(
                      (align) => (
                        <Button
                          key={align}
                          variant={
                            el.textAlign === align ? "default" : "ghost"
                          }
                          size="sm"
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      update({ borderWidth: parseInt(e.target.value) || 0 })
                    }
                    className="h-7 text-xs"
                  />
                </div>
              ...
              {el.shape === "rounded-rect" && (
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      update({ borderRadius: parseInt(e.target.value) || 0 })
                    }
                    className="h-7 text-xs"
                  />
                </div>
            ...
            <div className="space-y-2">
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    update({ objectFit: v as "cover" | "contain" | "fill" })
                  }
                >
                  <SelectTrigger className="h-7 text-xs">
                    <SelectValue />
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      update({ starSize: parseInt(e.target.value) || 24 })
                    }
                    className="h-7 text-xs"
                  />
                </div>
