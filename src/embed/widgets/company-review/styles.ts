...
.rw-co-header__rating-value{font-size:24px;font-weight:700;color:var(--rw-text,#1a1a2e);line-height:1}
.rw-co-header__stars{display:flex;gap:2px}
.rw-co-header__rating-count{font-size:13px;color:#6b7280}
.rw-co-distribution{margin-bottom:16px;padding:16px;background:#f9fafb;border-radius:var(--rw-radius,8px);border:1px solid var(--rw-border,#e5e7eb)}
...
.rw-co-distribution__label{display:flex;align-items:center;gap:2px;font-size:13px;font-weight:500;color:var(--rw-text,#1a1a2e);min-width:28px;justify-content:flex-end}
.rw-co-distribution__label .rw-star{width:12px;height:12px}
.rw-co-distribution__bar-outer{flex:1;height:8px;background:#e5e7eb;border-radius:4px;overflow:hidden}
...
.rw-co-distribution__count{font-size:12px;color:#6b7280;min-width:24px;text-align:right}
.rw-co-sources{margin-bottom:16px;padding:16px;border:1px solid var(--rw-border,#e5e7eb);border-radius:var(--rw-radius,8px)}
.rw-co-sources__title{font-size:14px;font-weight:600;color:var(--rw-text,#1a1a2e);margin-bottom:12px}
...
.rw-co-sources__icon{width:32px;height:32px;border-radius:6px;display:flex;align-items:center;justify-content:center;font-size:14px;font-weight:700;flex-shrink:0;color:#fff}
...
.rw-co-filters__btn{padding:6px 14px;font-size:13px;font-weight:500;color:#6b7280;background:#f3f4f6;border:1px solid #e5e7eb;border-radius:20px;cursor:pointer;transition:all .15s ease;white-space:nowrap;font-family:inherit}
...
.rw-co-review{padding:16px;border-radius:var(--rw-radius,8px);transition:box-shadow .15s ease}
.rw-co-review--bordered{border:1px solid var(--rw-border,#e5e7eb);background:#fff}
.rw-co-review--shadow{background:#fff;box-shadow:0 1px 3px rgba(0,0,0,.08),0 1px 2px rgba(0,0,0,.04)}
.rw-co-review--flat{background:#f9fafb}
.rw-co-review:hover{box-shadow:0 4px 12px rgba(0,0,0,.08)}
.rw-co-review__header{display:flex;align-items:center;gap:10px;margin-bottom:8px}
.rw-co-review__avatar{width:36px;height:36px;border-radius:50%;background:#e5e7eb;display:flex;align-items:center;justify-content:center;font-weight:600;font-size:14px;color:#6b7280;flex-shrink:0}
.rw-co-review__meta{flex:1;min-width:0}
.rw-co-review__name{font-weight:600;font-size:14px;color:var(--rw-text,#1a1a2e);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.rw-co-review__fthb-badge{display:inline-flex;align-items:center;gap:4px;font-size:11px;padding:2px 8px;border-radius:10px;font-weight:500;background:#ecfdf5;color:#047857;white-space:nowrap}
.rw-co-review__lo-attr{font-size:11px;padding:2px 8px;border-radius:10px;font-weight:500;background:#eff6ff;color:#1d4ed8;white-space:nowrap}
.rw-co-load-more{display:block;width:100%;margin-top:16px;padding:10px 24px;font-size:14px;font-weight:500;color:var(--rw-primary,#52796f);background:transparent;border:1px solid var(--rw-primary,#52796f);border-radius:6px;cursor:pointer;transition:background .15s ease,color .15s ease;font-family:inherit}
