...
.rw-filter-star-btn{background:none;border:1px solid var(--rw-border,#e5e7eb);border-radius:6px;padding:4px 10px;font-size:13px;cursor:pointer;color:var(--rw-text,#374151);transition:background .15s,border-color .15s}
...
.rw-filter-pill{background:var(--rw-bg,#fff);border:1px solid var(--rw-border,#e5e7eb);border-radius:16px;padding:3px 12px;font-size:12px;cursor:pointer;color:var(--rw-text,#374151);transition:background .15s,border-color .15s}
...
.rw-filter-search{flex:1 1 120px;min-width:120px;background:var(--rw-bg,#fff);border:1px solid var(--rw-border,#e5e7eb);border-radius:6px;padding:4px 10px;font-size:13px;color:var(--rw-text,#374151);font-family:inherit}
...
.rw-filter-empty p{margin:0 0 12px;font-size:14px}
.rw-filter-reset-btn{background:none;border:1px solid var(--rw-primary,#52796f);color:var(--rw-primary,#52796f);border-radius:6px;padding:6px 16px;font-size:13px;cursor:pointer;transition:background .15s}
