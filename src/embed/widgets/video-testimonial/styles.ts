...
.rw-vt__item{border:1px solid var(--rw-border,#e5e7eb);border-radius:var(--rw-radius,8px);overflow:hidden;background:#fff;transition:box-shadow .15s ease}
...
.rw-vt__poster-placeholder{position:absolute;inset:0;display:flex;align-items:center;justify-content:center;background:#1a1a2e;color:#9ca3af;font-size:14px}
...
.rw-vt__time{font-size:11px;color:rgba(255,255,255,.85);white-space:nowrap;min-width:70px;text-align:center;font-variant-numeric:tabular-nums}
...
.rw-vt__avatar{width:40px;height:40px;border-radius:50%;object-fit:cover;flex-shrink:0;background:#e5e7eb}
.rw-vt__avatar-placeholder{width:40px;height:40px;border-radius:50%;background:var(--rw-primary,#52796f);color:#fff;display:flex;align-items:center;justify-content:center;font-weight:600;font-size:16px;flex-shrink:0}
.rw-vt__reviewer-info{flex:1;min-width:0}
.rw-vt__reviewer-name{font-size:14px;font-weight:600;color:var(--rw-text,#1a1a2e);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.rw-vt__reviewer-title{font-size:12px;color:#6b7280}
.rw-vt__stars{display:flex;gap:2px;margin-bottom:8px}
.rw-vt__lo{display:flex;align-items:center;gap:10px;padding:10px 16px;border-top:1px solid var(--rw-border,#e5e7eb);background:#f9fafb}
.rw-vt__lo-photo{width:32px;height:32px;border-radius:50%;object-fit:cover;flex-shrink:0;background:#e5e7eb}
.rw-vt__lo-photo-placeholder{width:32px;height:32px;border-radius:50%;background:var(--rw-primary,#52796f);color:#fff;display:flex;align-items:center;justify-content:center;font-weight:600;font-size:13px;flex-shrink:0}
.rw-vt__lo-info{flex:1;min-width:0}
.rw-vt__lo-name{font-size:13px;font-weight:600;color:var(--rw-text,#1a1a2e)}
.rw-vt__lo-nmls{font-size:11px;color:#6b7280}
.rw-vt__lo-nmls a{color:var(--rw-primary,#52796f);text-decoration:none}
.rw-vt__lo-nmls a:hover{text-decoration:underline}
.rw-vt__lo-rating{display:flex;align-items:center;gap:4px;font-size:12px;font-weight:600;color:var(--rw-text,#1a1a2e)}
.rw-vt__lo-rating .rw-star{width:12px;height:12px}
.rw-vt__transcript{max-height:200px;overflow-y:auto;padding:12px 16px;border-top:1px solid var(--rw-border,#e5e7eb);background:#f9fafb}
.rw-vt__transcript-title{font-size:12px;font-weight:600;color:var(--rw-text,#1a1a2e);margin-bottom:8px}
.rw-vt__transcript-seg{font-size:13px;line-height:1.6;color:#6b7280;padding:2px 4px;border-radius:3px;cursor:pointer;transition:background .15s ease,color .15s ease}
...
.rw-vt__error-text{font-size:13px;color:#9ca3af}
.rw-vt__retry-btn{padding:8px 20px;font-size:13px;font-weight:500;color:#fff;background:var(--rw-primary,#52796f);border:none;border-radius:6px;cursor:pointer;transition:opacity .15s ease;font-family:inherit}
...
.rw-vt__disclaimer{margin-top:16px;padding:10px 14px;font-size:var(--rw-disclaimer-size,10px);line-height:1.5;color:var(--rw-text,#6b7280);opacity:0.8;background:var(--rw-bg,#f9fafb);border-radius:4px;border:1px solid var(--rw-border,#f3f4f6)}
.rw-vt__disclaimer__ehl{display:flex;align-items:center;gap:6px;margin-bottom:4px;font-weight:600;font-size:11px;color:var(--rw-text,#4b5563)}
.rw-vt__disclaimer__text{font-size:var(--rw-disclaimer-size,10px);line-height:1.5;color:var(--rw-text,#6b7280);opacity:0.8;margin-bottom:4px}
.rw-vt__disclaimer__nmls-link{font-size:10px;color:var(--rw-primary,#52796f);text-decoration:none}
.rw-vt__disclaimer__nmls-link:hover{text-decoration:underline}
.rw-branding{margin-top:12px;text-align:center;font-size:11px;color:#9ca3af}
.rw-branding a{color:#6b7280;text-decoration:none}
