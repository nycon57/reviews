...
.rw-vt__disclaimer{margin-top:16px;padding:10px 14px;font-size:10px;line-height:1.5;color:#6b7280;background:#f9fafb;border-radius:4px;border:1px solid #f3f4f6}
.rw-vt__disclaimer-ehl{display:flex;align-items:center;gap:6px;margin-bottom:4px;font-weight:600;font-size:11px;color:#4b5563}
.rw-vt__disclaimer-text{font-size:10px;line-height:1.5;color:#6b7280;margin-bottom:4px}
