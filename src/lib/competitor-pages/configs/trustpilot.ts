  ...
  caseStudies: [
    {
      ...
      metrics: [
        {
          ...
          before: "8 (Trustpilot)",
          after: "74",
          percentageChange: "+825%",
        },
        {
          label: "Review platforms managed",
          before: "Trustpilot only",
          after: "Google + Zillow + internal",
          percentageChange: "3x sources",
        },
        {
      ...
      quote:
        "Trustpilot gave us one company page on a consumer directory. RepWell gave every loan officer their own branded profile. Review volume exploded once LOs had skin in the game.",
    ...
    },
    {
      ...
      metrics: [
        ...
        {
          label: "Post-close surveys sent",
          before: "0 (Trustpilot has no surveys)",
          after: "200+/month (automated)",
        ...
        },
        {
          ...
          before: "Not tracked",
          after: "74",
          percentageChange: "New metric",
        },
      ],
      quote:
        "Trustpilot cannot send surveys or track NPS. Moving to RepWell gave us post-close automation, NPS tracking, and Google review management — none of which Trustpilot offers.",
      ...
      metrics: [
        {
          ...
          before: "15% (Trustpilot only)",
          after: "94% (all platforms)",
          percentageChange: "+527%",
        },
        {
          label: "Testimonials collected per quarter",
          before: "0",
          after: "30",
          percentageChange: "+30/quarter",
        },
        {
          label: "Monthly platform cost",
          before: "$259/mo (Trustpilot)",
          after: "$177/mo",
          percentageChange: "-32%",
        },
      ],
      quote:
        "We were paying Trustpilot $259/month for a consumer listing that did not integrate with anything in our stack. RepWell costs less and does 10x more for mortgage.",
      ...
      metrics: [
        {
          ...
          before: "0 (Trustpilot = 1 company page)",
          after: "12 (single dashboard)",
          percentageChange: "12 branches",
        },
        {
          label: "Social media posts from reviews",
          before: "1/month (manual)",
          after: "20/month (automated)",
          percentageChange: "+1,900%",
        },
        {
          label: "Compliance review time",
          before: "Manual (all responses)",
          after: "AI-assisted (spot check only)",
          percentageChange: "-80%",
        },
      ],
      quote:
        "Trustpilot's consumer platform had no multi-branch management, no compliance tools, no social publishing from reviews. RepWell covered every gap and then some.",
